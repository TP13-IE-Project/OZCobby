...
if ( ! function_exists( 'big_bob_header_style' ) ) :
	...
	function big_bob_header_style() {
		...
		if (!get_header_image() && !has_header_video() && !display_header_text() && !is_front_page() && !((get_theme_mod( 'big_bob_highlight_feature_image', 'Off' ) == 'On') && !is_front_page() && (is_page() || is_single()) ) ) :
			?>
			.wp-custom-header,
			...
			<?php
			if ((get_theme_mod('big_bob_center_nav', "Off") == "On") && (get_theme_mod('big_bob_menu_size', "Small") == "Medium") ):
				?>
		...
		elseif (( get_theme_mod( 'video_on_phone', 'On' ) == 'Off' ) && !get_header_image() && has_header_video() && !display_header_text() && !((get_theme_mod( 'big_bob_highlight_feature_image', 'Off' ) == 'On') && !is_front_page() && (is_page() || is_single()) )) :
			?>
